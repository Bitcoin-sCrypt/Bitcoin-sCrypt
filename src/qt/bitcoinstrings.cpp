...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for connections on <port> (default: 9333 or testnet: 1.4.0)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Specify configuration file (default: bitcoin-script.conf)"),
